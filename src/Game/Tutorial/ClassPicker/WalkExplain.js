...
export const WalkExplain = ({
  ...
  return (
    <Wrapper>
      <TitleWrapper>
        <Title>Click on a tile to walk to it.</Title>
      </TitleWrapper>
      <TutorialGameBoard
        isPaused={isPaused}
      ...
      />
      <ButtonsWrapper>
        <Button onClick={decrementTutorialViewIndex}>Menu</Button>
        <Button onClick={incrementTutorialViewIndex}>Next</Button>
      </ButtonsWrapper>
    </Wrapper>
  );
};
