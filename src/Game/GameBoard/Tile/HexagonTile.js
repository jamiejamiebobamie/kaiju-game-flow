...
const ICON_LOOKUP = {
  ...
  isOnFire: { className: "fa-tint", color: "#3c7fde" },//""fa-free-code-camp", color: "tomato" }, //  "fa-tint",
  ...
  isHomeBase: { className: "fa-ravelry", color: "BlueViolet" },
  IS_BLANK: { className: "", color: "" },
};
const determineIcon = status => {
  switch (true) {
    case !!status.isHomeBase:
      return ICON_LOOKUP["isHomeBase"];
